---
title: 'MCP Server'
description: 'Transforme Claude Code, Claude Desktop, Cursor, Windsurf ou ChatGPT no operador da sua conta WhatsApp. 14 ferramentas: você diz pra quem e o quê, a Arara resolve o resto.'
...
A v4 cortou o MCP de 84 pra um punhado de **14 ferramentas** enxutas. O motivo: agente bom não precisa de um painel de controle inteiro — precisa de poucas ações que aceitam o que um humano sabe de cabeça e resolvem o resto sozinhas.
...
<CardGroup cols={2}>
  <Card title="Ferramentas do MCP" icon="wrench" href="/mcp-tools">
    O que cada uma das 14 ferramentas faz, parâmetros e exemplos.
  </Card>
