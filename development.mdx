...
<CardGroup cols={2}>
  <Card title="Node.js/TypeScript" icon="node-js" href="https://github.com/ararahq/arara-js">
    SDK oficial para Node.js e TypeScript
  </Card>
  <Card title="Python" icon="python" href="https://github.com/ararahq/arara-python">
    SDK oficial para Python
  </Card>
  <Card title="Java" icon="java" href="https://github.com/ararahq/arara-java">
    SDK oficial para Java
  </Card>
  <Card title="Kotlin" icon="code" href="https://github.com/ararahq/arara-kotlin">
    SDK oficial para Kotlin
  </Card>
  <Card title="PHP" icon="php" href="https://github.com/ararahq/arara-php">
    SDK oficial para PHP
  </Card>
  <Card title="Ruby" icon="gem" href="https://github.com/ararahq/arara-ruby">
    SDK oficial para Ruby
  </Card>
  <Card title="Go" icon="code" href="https://github.com/ararahq/arara-go">
    SDK oficial para Go
  </Card>
  <Card title="Rust" icon="code" href="https://github.com/ararahq/arara-rust">
    SDK oficial para Rust
  </Card>
</CardGroup>
