...
<Card title="Objetivo Principal da Fase 1" icon="code-branch">
...
<Card title="Objetivo Principal da Fase 2" icon="laptop-code">
...
<Card title="Objetivo Principal da Fase 3" icon="sparkles">
