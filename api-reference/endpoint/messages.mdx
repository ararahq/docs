...
O endpoint de envio de mensagens permite que você envie mensagens via WhatsApp de duas formas:
...
|-------|------|-----------|
| `id` | string (UUID) | Identificador único interno do banco de dados |
| `internalId` | string | **ID Público Arara** (Ex: `ara_msg_...`). Use este ID para consultas e suporte. |
