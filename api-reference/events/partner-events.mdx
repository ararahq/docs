...
**Template usado:** `carrinho_abandonado_demo`
...
**Template usado:** `pagamento_nao_autorizado_v1`
...
**Template usado:** `pix_pagamento_criado_v2`
...
**Template usado:** `boleto_vencimento_hoje_v1`
...
| Evento | Template | Variáveis | Campos Especiais |
|--------|----------|-----------|------------------|
| `cart.abandoned` | `carrinho_abandonado_demo` | Nome, Loja, Valor, Link | - |
| `payment.failed` | `pagamento_nao_autorizado_v1` | Nome, Loja, Valor, Link | - |
| `pix.created` | `pix_pagamento_criado_v2` | Nome, Loja, Valor, Código PIX, Link | `code` (opcional) |
| `boleto.due` | `boleto_vencimento_hoje_v1` | Nome, Loja, Valor, Link | - |
