...
<Info>
  Hoje o único parceiro suportado é `abacate` (AbacatePay). Outros parceiros (Stripe etc) entram via Brain Actions ou por uma rota nova quando aprovados.
</Info>
...
url = "https://api.ararahq.com/v1/partners/abacate/events"
headers = {
...
const response = await fetch(
  'https://api.ararahq.com/v1/partners/abacate/events',
  {
    method: 'POST',
    headers: {
      'Authorization': 'Bearer sua_api_key_parceiro',
