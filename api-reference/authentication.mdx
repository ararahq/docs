...
Acesse o [Dashboard da Arara](https://dashboard.ararahq.com) e faça login usando sua conta. Se você ainda não tem uma conta, será criada automaticamente no primeiro login.
...
<CardGroup cols={2}>
  <Card title="Enviar Mensagens" icon="paper-plane" href="/api-reference/endpoint/send">
    Aprenda a enviar mensagens de template
  </Card>
